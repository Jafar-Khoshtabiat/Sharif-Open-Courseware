...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var sOCWUserDefaults: UserDefaults {
        if let _tempUserDefault = UserDefaults.init(suiteName: "SOCWUserDefaults") {
            return _tempUserDefault
        } else {
            fatalError("Cannot create UserDefaults")
        }
    }
}
